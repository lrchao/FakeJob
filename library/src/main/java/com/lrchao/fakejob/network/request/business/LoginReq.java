 ...
 * @date 2017/6/26 上午11:11
 */

public class LoginReq extends DialogRequest<LoginModel> {
    ...
    public void getParamsIntent(Intent intent) {
        ...
        mUserName = intent.getStringExtra(BundleKey.INTENT_EXTRA_LOGIN_USERNAME);
    ...
    protected String getUrlPath() {
        return "fake/wall/v1.0/user-login.json";
    }
